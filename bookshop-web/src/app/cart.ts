...
export class CartService {
  ...
  inventory = signal([
    { 
      id: 1, title: 'The Subtle Art of Not Giving a F*ck', author: 'Mark Manson', price: 850, type: 'Physical', salesCount: 150, readCount: 10, 
      cover: '', 
    ...
    { 
      id: 2, title: 'The Seven Husbands of Evelyn Hugo', author: 'Taylor Jenkins Reid', price: 920, type: 'Physical', salesCount: 140, readCount: 20, 
      cover: '',
    ...
    { 
      id: 3, title: 'The Moonlight Lilac Vol. 1', author: 'Cassncase', price: 650, type: 'Physical', salesCount: 115, readCount: 5, 
      cover: '',
    ...
    { 
      id: 4, title: 'The Moonlight Lilac Vol. 2', author: 'Cassncase', price: 650, type: 'Physical', salesCount: 98, readCount: 12, 
      cover: '',
      genre: 'Spicy Fantasy Romance', ageGroup: '18+ Adults', yearPublished: 2024,
      description: 'The second installment following hidden paths of moonlight magic where crowns clash and secrets break.'
    },
    { 
      id: 5, title: 'The Moonlight Lilac Vol. 3', author: 'Cassncase', price: 650, type: 'Physical', salesCount: 88, readCount: 15, 
      cover: '',
    ...
    { 
      id: 6, title: 'Kissing My Kryptonite', author: 'Moshnihart', price: 680, type: 'Physical', salesCount: 125, readCount: 8, 
      cover: '',
    ...
    { 
      id: 7, title: 'Illicit Affair', author: 'alittlesaucy', price: 720, type: 'Physical', salesCount: 110, readCount: 22, 
      cover: '',
    ...
    { 
      id: 8, title: 'Endless Love', author: 'gayreen', price: 590, type: 'E-Book', salesCount: 45, readCount: 195, 
      cover: '',
    ...
    { 
      id: 9, title: "Psychopath's Obsession", author: 'gayreen', price: 620, type: 'E-Book', salesCount: 55, readCount: 210, 
      cover: '',
    ...
    { 
      id: 10, title: 'The Psychology of Money', author: 'Morgan Housel', price: 790, type: 'E-Book', salesCount: 85, readCount: 180, 
      cover: '',
    ...
    { 
      id: 11, title: 'The Laws of Human Nature', author: 'Robert Greene', price: 1150, type: 'Physical', salesCount: 75, readCount: 30, 
      cover: '',
    ...
    { 
      id: 12, title: 'It Ends with Us', author: 'Colleen Hoover', price: 690, type: 'Physical', salesCount: 160, readCount: 40, 
      cover: '',
    ...
    { 
      id: 14, title: "A Good Girl's Guide to Murder", author: 'Holly Jackson', price: 640, type: 'E-Book', salesCount: 92, readCount: 188, 
      cover: '',
    ...
    { 
      id: 15, title: 'A Gentle Reminder', author: 'Bianca Sparacino', price: 480, type: 'E-Book', salesCount: 40, readCount: 175, 
      cover: '',
    ...
    { 
      id: 16, title: 'Powerless', author: 'Lauren Roberts', price: 890, type: 'E-Book', salesCount: 60, readCount: 155, 
      cover: '',
    ...
    { 
      id: 17, title: 'If He Had Been with Me', author: 'Laura Nowlin', price: 520, type: 'Physical', salesCount: 105, readCount: 25, 
      cover: '',
    ...
    { 
      id: 18, title: 'The Rain in España', author: 'Gwy Saludes', price: 750, type: 'Physical', salesCount: 130, readCount: 35, 
      cover: '',
  ...
  openDetails(book: any) {
    ...
    this.selectedFormat.set('Hardbound'); // resets toggle back to hardbound when opening any popup modal card
  }
  ...
  addToCart(book: any, chosenFormat: 'Hardbound' | 'E-Book') {
    // calculation for e-book discount of 300 pesos
